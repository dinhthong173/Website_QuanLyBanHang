							...
							<table class="shop-table">
								...
								<tbody>
									<c:forEach items="${bean}" var="ct">
										<tr>
											<td><img
												src='<c:out value="${ct.sanPham.hinh}"></c:out>' alt=""></td>
											<td>
											...
											<td><a
												href="CapNhatGioHang?sl=-1&id=<c:out value="${ct.sanPham.maSanPham}"/>"><button
														class="btn btn-warning">-</button> </a> <c:out
													value="${ct.soLuongSanPham}"></c:out> <a
												href="CapNhatGioHang?sl=1&id=<c:out value="${ct.sanPham.maSanPham}"/>"><button
														class="btn btn-warning">+</button> </a></td>
											<td>
												<h5>
													<strong class="red"> <c:out
															value="${ct.giaSanPham*ct.soLuongSanPham}"></c:out>
													</strong>
												</h5>
											</td>
											<td><a
								...
								<tfoot>
									<tr>
										<td colspan=""><a href="<c:url value="/"/>"><button
													class="pull-left">Tiếp tục mua sắm</button></a></td>
										<td><a href="XacNhanDonHang">
												<button class="btn btn-danger pull-right">Xác nhận
													đơn hàng</button>
										</a></td>
										<td>
											<h5>Tổng tiền:</h5>
		...
		<c:if test="${empty cart }">
			<div class="col-md-12">
				...
				<div class="col-md-6">
					...
					<br> <a href="/nhom18"><button class="pull-left">Quay
							lại mua sắm</button></a>
					<div class="clearfix"></div>
				</div>
				<div class="col-md-3"></div>
			</div>
