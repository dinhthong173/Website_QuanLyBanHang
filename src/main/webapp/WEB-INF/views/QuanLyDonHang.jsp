...
<link href="resources/css/styleQuanLyDonHang.css" rel="stylesheet"
	type="text/css">
</head>
<body>
	<div class="wrapper">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-2 col-sm-2">
						<div class="logo">
							<a href="QuanLyDonHang"> <img
								src="resources/images/HinhWebsite/logo.png" alt="Logo">
							</a>
						</div>
					</div>
						...
						<div class="header_bottom">
							...
							<div class="navbar-collapse collapse">
								<ul class="nav navbar-nav">
									<li class="active dropdown"><a href="QuanLyDonHang">
							...
							<tbody>
								<c:forEach items="${dsdhfalse}" var="dh">
									<tr>
											...
											<table class="tablemini">
												<c:forEach items="${dh.chiTietDonHangList}" var="listctdh">
													<tr>
														...
														<th><img alt=""
															src="<c:out value="${listctdh.sanPham.hinh}" />"></th>
													</tr>
												</c:forEach>
											</table>
										</td>
										...
										<td>
											<h5>
												<fmt:formatDate value="${dh.ngayTaoDonHang}"
													pattern="dd/MM/yyyy HH:mm:ss" />
											</h5>
										</td>

										<td><form:form
												action="QuanLyDonHangHuy?ma=${dh.maDonHang}" method="post">
												<input type="submit" value="Hũy" class="btn btn-danger">
											</form:form></td>
										<td><form:form
												action="QuanLyDonHangXacNhan?ma=${dh.maDonHang}"
												method="post">
