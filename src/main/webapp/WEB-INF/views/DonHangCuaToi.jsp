	...
	<div class="wrapper">
							...
							<table class="shop-table">
								...
								<tbody>
									<c:forEach items="${listCTDH}" var="ct">
										<tr>
											<td><c:out value="${ct.sanPham.tenSanPham}"></c:out></td>
											<td>
												<h5>
													<c:out value="${ct.sanPham.gia}"></c:out>
												</h5>
											</td>
											<td><c:out value="${ct.soLuongSanPham}"></c:out></td>
											<td>
												<h5>
					...
					<div class="col-md-12">
						...
						<c:if test="${not empty dsdonhang }">
							<table class="shop-table">
								...
								<tfoot>
									<tr>
										<td><a href="ThongTinCaNhan">
												<button type="button" class="btn btn-primary">Trở
													Về</button>
										</a></td>
									</tr>
								</tfoot></tbody>
		...
		<c:if test="${empty dsdonhang }">
			<div class="col-md-12">
				...
				<div class="col-md-6">
					<h5>
						<strong class="red"> Bạn chưa có đơn hàng nào. <br>
							Quay lại trang chủ để chọn sản phẩm vào giỏ hàng.
						</strong>
					</h5>
					<br> <a href="/nhom13"><button class="pull-left">Quay
