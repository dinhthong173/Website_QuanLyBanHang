			...
			<div class="container">
				<div class="row">
					<div class="col-md-2 col-sm-2">
						<div class="logo">
							<a href="QuanLySanPham"> <img
								src="resources/images/HinhWebsite/logo.png" alt="Trang Chu">
							</a>
						</div>
					</div>
								...
								<div class="col-md-3">
									...
									<ul class="usermenu">
										<li>
											<div>
												<p style="color: white;">
													<a class="log">Admin :</a> <strong style="color: blue;"><%=session.getAttribute("user")%></strong>
												</p>
											</div>
										</li>
						...
						<div class="header_bottom">
							...
							<div class="navbar-collapse collapse">
								<ul class="nav navbar-nav">
									...
									<li class="active dropdown"><a href="QuanLySanPham">
								...
								<tr>
									<td align="center" width="20%">
										<button class="" data-toggle="modal"
											data-target="#myModalThem">Thêm mới sản phẩm</button>
										<p class="text-danger"><c:out value="${thongbao}"></c:out></p>
									</td>
									<td width="40%"></td>
									<td align="right" width="100%">
										<form action="QuanLySanPham_TimTen" method="post"
											class="timkiem">
											<h5>
										...
										<form action="QuanLySanPham_TimDanhMuc" method="post"
											class="timkiem">

											<h5>
												Tìm theo danh mục: <select name="madanhmuc"">
												...
												</select> <input type="submit" value="Tìm kiếm" class="btn btn-info">
											</h5>
										</form>
									</td>
								</tr>
							...
							<tbody>
								<c:forEach items="${dssp}" var="sp">
									<tr>
										...
										<td><a
											href="QuanLySanPham_SuaSanPham?id=<c:out value="${sp.maSanPham}"/>">
											...
											<form:form action="ThemSanPham" method="post"
												...
												<div class="form-group">
													<label>Tên sản phẩm :</label> <input type="text"
														class="form-control" name="tensanpham" required>
												</div>
												<div class="form-group">
													<label>Giá:</label> <input type="text" class="form-control"
														name="gia" required
														pattern="^([1-9][0-9]{0,10}|100000000)$">
												</div>
												<div class="form-group">
													<label>Số lượng:</label> <input type="text"
														class="form-control" name="soluong" required
														pattern="^([1-9][0-9]{0,10}|1000)$">
												</div>
												<div class="form-group">
													<label>Mô tả:</label> <input type="text"
														class="form-control" name="mota" required>
												</div>
												<div class="form-group">
													<label>Hình ảnh:</label> <input type="file"
														class="form-control" name="file" id="fileToUpload"
														accept="image/*" pattern="([\w|\s|-|\])*\.(?:jpg|gif|png)"
														required />
												</div>
												<div class="form-group">
