...
public class NguoiDungDAO{
     ...
     * @generated DT_ID=none
     */
    public NguoiDung getNguoiDungFindByEmail(String email) {
        return (NguoiDung) em.createNamedQuery("NguoiDung.findByEmail").setParameter("email", email).getResultList();
    }
